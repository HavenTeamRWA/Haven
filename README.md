# Haven AI Yield Documentation

> The Autonomous Execution Layer for On-chain Fixed Income

Haven is the first AI-powered protocol that automates capital allocation across stablecoins, RWAs, and quantitative strategies — creating a unified gateway between DeFi and TradFi fixed-income markets.
...
→ Get started with the [Overview](getting-started/overview.md)
